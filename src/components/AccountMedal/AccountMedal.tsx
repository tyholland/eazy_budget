  ...
  return (
    <S.Wrapper>
      ...
      {isFree && (
        <>
          <div>
            Take part in the Medal Game and earn a free 1-month trial of the Pro
            Plan, applied to your account once you claim your prize.
          </div>
          <div>
            Complete the tasks below, rack up points, and aim for 180 points to
            achieve the ultimate Gold Elite Medal.
          </div>
          <div>
            Ready to level up your budgeting skills and claim your reward? Let's
      ...
      <div>
        ...
        <S.Item>
          <div>Add expenses under the “Non-Discretionary” category</div>{" "}
          {expenses_in_category_1 ? <SaveIcon /> : <DisabledSaveIcon />}
        </S.Item>
        <S.Item>
          <div>Add expenses under the “Savings” category</div>{" "}
          {expenses_in_category_2 ? <SaveIcon /> : <DisabledSaveIcon />}
        </S.Item>
        <S.Item>
          <div>Add expenses under the “Fun Money” category</div>{" "}
      ...
      <div>
        ...
        <S.Item>
          <div>Adding at least one new category per month</div>
