...
const MedalProgress = () => {
  ...
  const totalPoints = currentUser?.total_medal_points || 0;
    ...
    return (
      <S.ProgressBar>
        ...
        <S.Meter>
          ...
          <S.Block
            className={totalPoints > 100 || totalPoints >= 105 ? "active" : ""}
          >
            &nbsp;
          </S.Block>
          <S.Block
            className={totalPoints > 105 || totalPoints >= 110 ? "active" : ""}
          >
            &nbsp;
          </S.Block>
          <S.Block
            className={totalPoints > 110 || totalPoints >= 115 ? "active" : ""}
          >
            &nbsp;
          </S.Block>
  ...
  if (totalPoints <= 150) {
    return (
      <S.ProgressBar>
        ...
        <S.Meter>
          <S.Block
            className={totalPoints > 120 || totalPoints >= 125 ? "active" : ""}
          >
            &nbsp;
          </S.Block>
          <S.Block
            className={totalPoints > 125 || totalPoints >= 130 ? "active" : ""}
          >
            &nbsp;
          </S.Block>
          <S.Block
            className={totalPoints > 130 || totalPoints >= 135 ? "active" : ""}
          >
            &nbsp;
          </S.Block>
          <S.Block
            className={totalPoints > 135 || totalPoints >= 140 ? "active" : ""}
          >
            &nbsp;
          </S.Block>
          <S.Block
            className={totalPoints > 140 || totalPoints >= 145 ? "active" : ""}
          >
            &nbsp;
          </S.Block>
  ...
  if (totalPoints <= 180) {
    return (
      <S.ProgressBar>
        ...
        <S.Meter>
          <S.Block
            className={totalPoints > 150 || totalPoints >= 155 ? "active" : ""}
          >
            &nbsp;
          </S.Block>
          <S.Block
            className={totalPoints > 155 || totalPoints >= 160 ? "active" : ""}
          >
            &nbsp;
          </S.Block>
          <S.Block
            className={totalPoints > 160 || totalPoints >= 165 ? "active" : ""}
          >
            &nbsp;
          </S.Block>
          <S.Block
            className={totalPoints > 165 || totalPoints >= 170 ? "active" : ""}
          >
            &nbsp;
          </S.Block>
          <S.Block
            className={totalPoints > 170 || totalPoints >= 175 ? "active" : ""}
          >
            &nbsp;
          </S.Block>
