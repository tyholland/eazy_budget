...
const ChartIcon = () => {
  return (
    <svg
      version="1.0"
      viewBox="0 0 130.05653 128.09375"
      width={30}
      height={30}
    ...
    >
      ...
      <g transform="translate(-136.04 -.03125)">
        ...
        />
        <rect
          transform="matrix(.96593 -.25882 .25882 .96593 339.82 -287.5)"
          x="-277.42"
          y="259.63"
          width="108.41"
          height="86.727"
        ...
        <path
          transform="translate(339.82,-287.5)"
          d="m-104.38 308.95-17.6 14.94 6.88 3.23-0.91 2.06c1.84-1.5 3.7-3.01 5.5-4.5 2.41-2.46 4.62-5.57 6.2-9.12l-0.07-6.61zm-34.96 28.21-0.07 2.84-0.26 8.91c1.65-1.45 3.32-2.91 5-4.33l0.04-1.57 1.51 0.26c1.63-1.38 3.26-2.73 4.9-4.08l-8.3-1.52-2.82-0.51zm-27.65 9.65-0.79 2.34-13.45 39.12 2.15 8.24c0.22-0.47 0.46-0.93 0.69-1.39l14.43-42.03 14.23 5.03c1.31-1.27 2.66-2.51 4-3.76l-18.91-6.74-2.35-0.81z"
          fill="url(#e)"
        />
      </g>
    </svg>
